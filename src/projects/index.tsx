        ...
        <section className={style.project}>
          <div className={style.project__introduction}>
            ...
            <div className={style.project__introduction__location}>
              <p><strong>Ansvarlig lokasjon</strong></p>
            ...
            {interviews.map((interview: Interview) => {
              return (
                <div className={style.project__interview}>
                  <p className={style.textCenter}><strong>{interview.variant}</strong></p>
                  <p className={style.textCenter}>{interview.variantTitle}</p>
                  <img src={interview.image} alt={interview.imageAltText} />
                  <p>{interview.quote}</p>
                  <Link
                    
                    href={`/intervju/${interview.name}`}
                  >
                    <a className={style.buttonLink}><strong>Les mer</strong></a>
                  </Link>
                </div>
              );
            })}
          ...
          <div className={style.contribution}>
            ...
            <div>
              <div className={style.contributionElements}>
                <p>En setning eller to for å oppsummere her. I høyremargen: Vinkle opp mot tjenesteområder, få frem helheten av det som leveres. --></p>
                <img src="/images/tjenestefjell.png" alt="Tjenestefjell"/>
              </div>
                
              <div className={style.contributionElements}>
                <div>
                  <p><strong>Digital produktutvikling</strong></p>
                  <p>Skriv noe om hva vi har bidratt med innenfor dette tjenesteområdet.</p>
                </div>
                <div>
                  <p><strong>Datadrevet</strong></p>
                  <p>Skriv noe om hva vi har bidratt med innenfor dette tjenesteområdet.</p>
                </div>
                <div>
                ...
                <div>
                  <p><strong>Culture first</strong></p>
                  <p>Skriv noe om hva vi har bidratt med innenfor dette tjenesteområdet.</p>
                </div>
          ...
          <div className={style.quote}>
            <blockquote>Statens Vegvesen har vært en trygg og god start for en fersk konsulent. Det har vært verdifullt å se at min erfaring og kunnskap har blitt verdsatt og ønsket.</blockquote>
          </div>
        </section>
      </Layout>
    );
