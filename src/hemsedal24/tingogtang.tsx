    ...
    <div className={styles.tur} style={{ paddingTop: '3rem' }}>
      <Container id="ting">
        ...
        <div className={styles.omHotellet}>
          <h4>Om hotellet</h4>
          <p>
            Hvis du ikke allerede har tatt en titt på hotellet, så kan du sjekke
            det ut <Link href="https://fyriresort.com/pool-club/">HER</Link>.
          </p>
          <br />
          <p>
            Fýri ligger ved Hemsedal skisenter, og er (som de beskriver det
            selv) ”stedet for de sosiale, eventyrlystne og nysgjerrige”. Guuuuuu
        ...
        <div className={styles.pakkeliste}>
          ...
          <div>
            ...
            <p>
              ...
              <br />(
              <Link href="https://www.yr.no/nb/værvarsel/daglig-tabell/10-1032550/Norge/Buskerud/Hemsedal/Totteskogen">
                ta en titt på værmeldingen
              </Link>
              )
            </p>
            <p>Varianter: pc til workshoppen på fredag 💻 </p>
          </div>
        </div>
        <div className={styles.aktivitetene}>
          <div className={styles.aktivitetstekst}>
            ...
            <p>
              Det er mye forskjellig som skjer på lørdagen, så vi har samlet alt
              på ett sted slik at det skal være enkelt å finne ut av
              hvem/hva/hvor og alt imellom💥{' '}
            </p>
          </div>

          {mobile ? (
            <a href={'/hemsedal24/aktiviteter'}>
              <div className={styles.mobilearrowblob}>
                <img src={arrowblob} alt="blob" />
              </div>
            </a>
          ) : (
            <div className={styles.arrowtoblob}>
              <div className={styles.squiggly}>
                <img src={squiggly} alt="arrow" />
              </div>
              <a href={'/hemsedal24/aktiviteter'}>
                <div>
                  <img src={a_blob} alt="blob" />
                </div>
              </a>
            </div>
          )}
        ...
        {mobile ? (
          <div className={styles.utsiktsblob}>
            <img src={utsiktmobil} alt="utsiktsblob" />
          </div>
        ) : (
          <div className={styles.utsiktsblob}>
            <img src={utsiktpc} alt="utsiktsblob" />
          </div>
        )}
        <a href="#ting">
