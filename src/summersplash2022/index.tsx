...
const Summersplash2022: NextPage<InferGetStaticPropsType<typeof getStaticProps>> = () => {
	...
	const queryedPage = router.query.dynmaicPath;
	...
	const [mode, setMode] = useState(
		router.query.dynmaicPath === 'sommerjobb' ? 'internship' : 'job',
	);
	...
	useEffect(() => {
		setMode(router.query.dynmaicPath === 'sommerjobb' ? 'internship' : 'job');
	}, [router.query.dynmaicPath]);
