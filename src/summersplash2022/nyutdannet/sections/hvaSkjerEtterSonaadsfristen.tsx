...
const AfterApplying = ({applyType} : {applyType: ApplyType})  => {
  ...
  const timelineImage = applyType === ApplyType.GRADUATE ? 
   require('../img/graduate timeline.svg') : require('../../img/timeline.svg');

  const timelineDescription = applyType == ApplyType.GRADUATE ? `Søknadsfrist: 1.oktober, Kaffeprat: 4.-5.oktober, tilbud om sommerjobb: 6.oktober
      ...
      <div className={style.section6Flex}>
        <div className={style.section6About}>
          ...
          <p>
            ...
            muligheter til å bli bedre kjent før {isApplyGraduate ? "man starter" : "sommerjobben starter i juni"}.
          </p>
        </div>
        ...
        <div className={style.section6ApplicationTips}>
          ...
          <p>
            ...
            dine ambisjoner. Så hvem er du og hvorfor søker du {isApplyGraduate ? "jobb" : "sommerjobb"} i
