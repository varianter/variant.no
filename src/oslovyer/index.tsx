    ...
    <Layout>
      <Wrapper mode="purple" className={styles.page1}>
        <Content mode="right_bottom">
          ...
          <p>
            Her har vi skrevet litt om våre tanker om å bygge Variant i Oslo. Nå
            er vi spente på hva du tenker. Hva tror du er viktig for å lykkes?
            Hvordan ønsker du å utvikle Oslo sammen med oss?
          </p>
        </Content>
      </Wrapper>
      ...
      <Wrapper className={styles.page2}>
        <Content mode="left">
          ...
          <Block>
            <h2>Vil du utvikle Variant Oslo AS?</h2>
            ...
            <p>
              ...
              Osloselskapet skal bygges og drives. Vi gir dere frihet som om
      ...
      <Wrapper className={styles.page3}>
        <Content mode="left">
          ...
          <div className={styles.strong}>
            <p>
              ...
              Hvordan tror vi at Variant Oslo kan bli? Sånn litt inn i framtida?
              Dette er tanker som du og ditt team må være med å forbedre og
              foredle. Så med alle forbehold, her er slik vi ser for oss at 2024{' '}
              <i>kan</i> se ut.
            </p>
          </div>
          ...
          <div className={styles.em}>
            <p>
              I løpet året flytter Variant Oslo inn et eget lokale sentralt i
              Oslo sentrum. Lokalene er relativt store og attraktive, og er
            ...
            <p>
              I løpet av høsten starter konsulent nr 50. Det er en god balanse
              mellom designere og utviklere. I tillegg er det en litt mindre
              gruppe prosjektledere. I år omsetter selskapet for 65 millioner og
              genererer et overskudd på 7,5 millioner. Omsetningen kommer fra en
              lik fordeling mellom CV-baserte oppdrag, relasjonssalg og
              prosjekter med ansvar og risiko.
            </p>

            <p>
              Under både lokale og nasjonale variantdager, bidrar Oslo-varianter
              med læreglede, faglige bidrag og innsats for å utvikle selskap og
              konsern. Variantdagen i november arrangeres bare for Oslo. Her
              gjennomføres 4 ulike faglige track. Et av dem er variant:skudd som
              bidrar til å gjøre konsulenter av de 6 nyutdannede variantene som
              startet i august. Hver måned publiserer Oslo-varianter 3 faglige
        ...
        <Content mode="right" className={styles.page3__right}>
          <div className={styles.em}>
            ...
            <p>
              I mai oppnådde Variant som helhet en 5.-plass i Universums kåring
      ...
      <Wrapper className={styles.page4}>
        <Content mode="left">
          ...
          <div className={styles.page4__padded}>
            ...
            <div className={styles.em}>
              <p>
                Ved oppstart 1. september 2021 har vi 6 ansatte. Dette er da
              ...
              <p>
                ...
                Oslo støtter seg kraftig på konsernets rekrutteringskapasitet.
              </p>
              ...
              <p>
                ...
                Oslo også begynt å vinne egne kunder. Men gjennom hele det
        ...
        <Content mode="right">
          <div className={styles.em}>
            <p>
              Det første året gjennomføres Variantdager sammen med Oslo. Dels
              over video og dels ved reiser mellom byene. 1. september 2022
              feirer Oslo ettårsdagen med en Varianttur på egenhånd sammen med
              følge til Berlin.
            </p>

            <p>
              Den første tiden leier Variant Oslo dedikerte arbeidsplasser på
              Mesh. Antallet rom og arbeidsplasser utvides etter hvert som vi
              vokser. Konsernet stiller med struktur- og systemkapital.
              Konsernets ledelse jobber tett på en coachende måte med Oslos
              ledergruppe.
            </p>
          </div>
        </Content>
