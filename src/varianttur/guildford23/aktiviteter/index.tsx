    ...
    <div className={style.container}>
      <div id='activities' className={style.topContainer}>
        ...
        <div className={style.headerContainer}>
          <h2>Aktiviteter</h2>
          <p>På lørdag skal vi på aktiviteter vi meldte oss på tidligere i år 🏰 🎢 🍷 🍸 🌆</p>
        </div>
      </div>
      {activities.map((activity, index) => <Activity key={index} activity={activity} imageFirst={index % 2 !== 0} />)}
