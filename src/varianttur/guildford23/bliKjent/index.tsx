    ...
    <div className={style.container}>
      <div className={style.contentContainer}>
        ...
        <div id="intro" className={style.headerContainer}>
          ...
          <p className={style.introText}>
            Som dere vet, stilte vi noen spørsmål for å hjelpe dere litt på vei
            til å si noe om dere selv:
          </p>
          <div className={style.questions}>
            ...
            <p className={style.question}>
              Fun facts om deg selv: Har du hobbyer? Samler du på noe? Hvilken
              type musikk liker du? Kan du partytriks? Du trenger ikke å svare
              på alt, men håper spørsmålene kan gi litt inspirasjon 🥳
            </p>
          </div>
        </div>
        {getToKnowResults.map((result, index) => (
          <div key={index}>
            <VariantPlusOne variant={result} variantIndex={index} />
          </div>
        ))}
      </div>
