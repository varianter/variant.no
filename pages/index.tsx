...
const Home = () => {
  return (
    <Layout>
      <section>
        <h2>Raust, åpent og læreglede</h2>
        <p>
      ...
      <section>
        ...
        <a href="http://variant.blog">Sjekk oss ut på</a>
      </section>
      ...
      <section>
        <article>
          ...
          <p>
            ...
            oppnå dette. De skal blant annet lage nye mobilapper, ny nettbutikk,
            ny sanntidsvisning og bransjens beste ruteplanlegger.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            ...
            intelligens i styring av kraftproduksjon og handel på kraftmarkedet.
            Her er TrønderEnergi pionerer. Tonje, Magnus og Kristin er så
            heldige å få bidra til realisering av ulike prosjekter som design av
            fysiske driftsmiljø, tjenestedesign for AI-løsninger og
            prosjektkommunikasjon.
          </p>
        </article>

        <article>
          <h3>Ren Røros - lokal forretningsutvikling med globale ambisjoner</h3>

          <p>
            Det som tidligere het Røros Elektrisitetsverk AS med alle sine
            datterselskap, har gjennom de to siste årene gjennomgått en voldsom
            endringsprosess. Selskapet har rigget seg til å bli Ren Røros – en
            organisasjon som skal drive frem elektrifisering, fornybar
            energiproduksjon og ny bærekraftig klimateknologi. Det hele gjennom
            en helhetlig forretningsstruktur som fokuserer på klima,
            brukerreiser og interne synergieffekter. I prosessen har Tonje,
            Ellen og Magnus bistått med forretningsdesign, strategiarbeid,
            tjenestedesign, selskapsidentitet og kulturbygging i tett samarbeid
            med de ansatte. Ren Røros hevder med ordene i behold at “Vi har både
            kunnskap om tilstanden jorda vår er i, og kompetanse til å gjøre noe
            med det”. Vi er stolte over å jobbe med kunder som våger å investere
            i fremtidens klimaløsninger!
          </p>
        </article>
      </section>
    </Layout>
