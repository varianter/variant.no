    ...
    <>
      ...
      <div>
        ...
        <p>
          ...
          <Link href="/jobs/ceo-i-variant-bergen">utlysningen</Link> til
    ...
    <Layout>
      <div>
        ...
        <section className={style.omVariant}>
          <header>
            <h2 className={style.omVariant__title}>Velkommen PERSON!</h2>
          </header>
          <div>
            <p>
          ...
          <div>
            <h3 className="fancy">Tidsplan 21. januar</h3>
