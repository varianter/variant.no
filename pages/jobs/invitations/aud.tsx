    ...
    <Layout>
      <div>
        ...
        <section className={style.omVariant}>
          <header>
            <h2 className={style.omVariant__title}>Velkommen Aud Marie</h2>
          </header>
          <div>
            <p>
              Det er med stor glede vi inviterer til en liten dag hos oss på
              Varianthuset i Trondheim tirsdag 23. mars. Målet med dagen er å bli bedre kjent med
          ...
          <div>
            <h3 className="fancy">Tidsplan tirsdag 23. mars</h3>
            <ul className={style.agenda}>
              <li>
                <span className={style.time}>13.00-14.00</span> 🥘 Lunsj
              </li>
              <li>
                <span className={style.time}>14.00-15.00</span> 💪🏻 Styrkesamtale
              </li>
              <li>
                <span className={style.time}>15.30-17.30</span> 👩‍👦‍👦
                Samarbeidscase{' '}
              </li>
            </ul>
          </div>
