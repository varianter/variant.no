    ...
    <Layout>
      <div>
        ...
        <section className={style.omVariant}>
          <header>
            <h2 className={style.omVariant__title}>Velkommen [NAVN]!</h2>
          </header>
          <div>
            <p>
              Det er med stor glede vi inviterer til en liten dag hos oss på
              Varianthuset i Trondheim [DATO]. Målet med dagen er å bli bedre
          ...
          <div>
            <h3 className="fancy">Tidsplan [DATO]</h3>
          ...
          <div>
            ...
            <p className={style.prep}>
              ...
              forteller litt om dine tanker rundt Oslos rekruttering på kort og
